...
function Home() {
  ...
  const hasFeaturedMovies = featuredMovies.length > 0;
  ...
  const featuredMovie = hasFeaturedMovies
  ...
  const featuredRating =
    featuredMovie?.imdbRating && featuredMovie.imdbRating !== "N/A"
      ...
      : "No rating";
  const heroCopy = featuredMovie
    ? `Revisit a standout ${featuredMovie.Type || "movie"} from ${
  ...
  return (
    <>
      {featuredError || !hasFeaturedMovies ? (
        <section className="hero-status">
          {featuredError || "No featured movies available."}
        </section>
      ) : (
        <section
        ...
        >
          ...
          <div className="hero-content">
            ...
            <Link
              to={`/movies/${featuredMovie.imdbID}`}
